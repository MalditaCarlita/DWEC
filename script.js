...
function abrirVentana(){
    const nuevaVentana = window.open('ventana.html','nueva','width=800,height=400,resizable=false');
}
...
botonEnviar.addEventListener('click',()=>{
    ...
    <p>La posición de la primera A de tu nombre es ${nombre.toLowerCase().indexOf('a')+1} </p>

    <p>La última letra A de tu nombre está en la posición:${nombre.toLowerCase().lastIndexOf('a')+1}</p>
